        ...
        for (Map.Entry<String, Mapping> u : this.mappingUrls.entrySet()) {
            ...
            if (u.getKey().equals(path)) {
                try {
                    ...
                    if (method.isAnnotationPresent(Api.class) == false) {
                        ModelView view = null;
                        ...
                        if (method.isAnnotationPresent(Auth.class)) {
                            ...
                            if (currentUser == null) {
                                ...
                                if (currentUser.equals(authProfile)) {
                                    ...
                                    view = (ModelView) method.invoke(o, invokationParams);
                                } else if (currentUser.equals(authProfile) == false
                                        && authProfile.equals("") == false) {
                                    throw new ServletException("Invalid session");
                                }
                            }
                        }
                        ...
                        if (view.isJson()) {
                            ...
                            RequestDispatcher dispatcher = getServletContext()
                                    .getRequestDispatcher("/views/" + view.getView());
                            dispatcher.forward(req, res);
                        }
                    } else if(method.isAnnotationPresent(Api.class)) {
                        Object result = method.invoke(o, invokationParams);
